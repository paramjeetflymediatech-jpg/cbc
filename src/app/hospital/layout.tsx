    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="p-6 space-y-6">
          ...
          {hospital && (
            <div className="p-3 bg-white/5 border border-white/10 rounded-xl space-y-1">
              <span className="text-[10px] font-bold text-[#ec2c6c] uppercase tracking-wider">
                Hospital Portal
              </span>
              <h4 className="text-sm font-bold text-white truncate">{hospital.name}</h4>
              <p className="text-xs text-gray-400 truncate">{hospital.city}</p>
            </div>
          )}
              ...
              return (
                <Link
                  ...
                  className={`flex items-center px-3.5 py-2.5 rounded-xl text-sm font-medium transition-colors ${
                    isActive
                      ? 'bg-[#ec2c6c] text-white font-bold shadow-lg'
        ...
        <div className="p-4 border-t border-gray-800">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-2.5 rounded-xl text-sm font-semibold text-gray-400 hover:text-white hover:bg-red-500/10 hover:border-red-500/30 border border-transparent transition-all"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <button
            className="lg:hidden p-2 text-gray-700 hover:text-[#ec2c6c]"
          ...
          <div className="flex items-center space-x-3 ml-auto">
            <span className="text-xs font-semibold text-gray-500">Welcome, {user.name}</span>
            <div className="w-8 h-8 rounded-full bg-pink-100 text-[#ec2c6c] flex items-center justify-center font-bold text-xs">
