...
export async function seedDatabase() {
  ...
  const additionalHospitals = [
    ...
    },
    {
      ...
      logo: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&auto=format&fit=crop&q=80',
    ...
    },
    {
      ...
      website: 'https://ludhianadental.com',
      ...
      logo: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=800&auto=format&fit=crop&q=80',
    ...
    },
    {
      ...
      logo: 'https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=800&auto=format&fit=crop&q=80',
      coverImage: 'https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=800&auto=format&fit=crop&q=80',
      rating: 4.8,
      isFeatured: true,
      isNabhAccredited: true,
      isVerifiedPartner: true,
    ...
    },
    {
      ...
      logo: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&auto=format&fit=crop&q=80',
      coverImage: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&auto=format&fit=crop&q=80',
      rating: 4.7,
      isFeatured: false,
      isNabhAccredited: true,
      isVerifiedPartner: true,
  ...
  for (const item of additionalHospitals) {
    const existing = await Hospital.findOne({ where: { slug: item.slug } });
    if (!existing) {
